...
led2 = 12, //Connect LED 2 To Pin #3 
led3 = 11, //Connect LED 3 To Pin #4 
...
//-----------------------------------------------------------------------//    
  ...
  else if(voice == "lights on") {digitalWrite(led4, HIGH);}
  //else if(voice == "AC on") {digitalWrite(led5, HIGH);}
  //----------Turn Off One-By-One----------// 
  else if(voice == "TV off") {digitalWrite(led1, LOW);} 
  else if(voice == "fan of") {digitalWrite(led2, LOW);}
  else if(voice == "AC off") {digitalWrite(led3, LOW);}
  else if(voice == "lights off") {digitalWrite(led4, LOW);}
  //else if(voice == "*AC off") {digitalWrite(led5, LOW);}
//-----------------------------------------------------------------------//  
